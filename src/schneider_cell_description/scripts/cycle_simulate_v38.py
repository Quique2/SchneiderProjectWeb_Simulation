#!/usr/bin/env python3
"""V38 offline cycle simulation.

Walks the cobot through the full process cycle using V38 IK-resolved
...
# V38 cycle (LEFT pick + disc index + vision + bin + return home)
CYCLE_STAGES = [
...
def main():
    ...
    log("=" * 80)
    log("V38 OFFLINE RUNTIME CYCLE (DXF layout, cobot on mesa, LEFT pick)")
    log("=" * 80)
    ...
    log_path = os.path.abspath(os.path.join(HERE, "../../../../evidence/logs/runtime_cycle_v38.log"))
