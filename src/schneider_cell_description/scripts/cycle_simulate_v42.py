#!/usr/bin/env python3
"""V42 offline cycle simulation.

Walks the cobot through the full process cycle using V42 IK-resolved
...
# V42 cycle (LEFT pick + disc index + vision + bin + return home)
CYCLE_STAGES = [
...
# V42: relaxed from 2.5 to 4.0 rad because the top-down R_target IK
...
def main():
    ...
    log("=" * 80)
    log("V42 OFFLINE RUNTIME CYCLE (DXF layout, cobot on mesa, LEFT pick)")
    log("=" * 80)
    ...
    # vision_sim V42 uses VISION=(0.824, 0.804, 1.050) +-(0.120, 0.120, 0.090).
    ...
    log_path = os.path.abspath(os.path.join(HERE, "../../../../evidence/logs/runtime_cycle_v42.log"))
