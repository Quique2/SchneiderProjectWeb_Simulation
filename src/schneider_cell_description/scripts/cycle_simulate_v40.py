#!/usr/bin/env python3
"""V40 offline cycle simulation.

Walks the cobot through the full process cycle using V40 IK-resolved
...
# V40 cycle (LEFT pick + disc index + vision + bin + return home)
CYCLE_STAGES = [
...
def main():
    ...
    log("=" * 80)
    log("V40 OFFLINE RUNTIME CYCLE (DXF layout, cobot on mesa, LEFT pick)")
    log("=" * 80)
    ...
    # vision_sim V40 uses VISION=(0.824, 0.804, 1.050) +-(0.120, 0.120, 0.090).
    ...
    log_path = os.path.abspath(os.path.join(HERE, "../../../../evidence/logs/runtime_cycle_v40.log"))
